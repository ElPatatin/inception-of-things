...
You can do it now or later, by its easier now. Set up your ssh. It should work out of the box. On you host machine connect to the vm with 'ssh root@localhost -p 2222'. If prompted with errors, try to resolve it with 'ssh -keygen -f "/home/$USER/.ssh/known_hosts" -R "[localhost]:2222"'.
...
This good man may be the only one with a simple enough guide and actually funcional guide on how to install a lightweight GUI on alpine: 'https://breder.org/alpine-setup'
